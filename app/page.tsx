    ...
    <div style={{ backgroundColor: "white" }}>
      <section className="relative text-white px-8 py-16" style={{ backgroundImage: "url('/hero.png.png')", backgroundSize: "cover", backgroundPosition: "center" }}>
        ...
        <div className="relative z-10 max-w-5xl mx-auto">
          <div className="mb-4">
            <Image src="/logo.png" alt="logo" width={300} height={95} className="object-contain drop-shadow-lg" />
          </div>
          <h1 className="text-5xl font-black mb-4 leading-tight text-white drop-shadow-lg">{teamConfig.catchphrase}</h1>
          <p className="text-2xl mb-8 font-black text-white drop-shadow-lg">{teamConfig.subCatchphrase}</p>
          <div className="flex flex-wrap gap-4 items-center">
            <Link href="/apply" className="bg-yellow-400 text-gray-900 font-black px-10 py-4 rounded-full text-xl hover:bg-yellow-300 transition shadow-lg">体験を申し込む</Link>
            <HowToUseModal />
          </div>
        </div>
      ...
      <section className="max-w-5xl mx-auto px-4 pt-6" style={{ backgroundColor: "white" }}>
